...
class StructuredLogger {
  StructuredLogger({required String canal, LogSink? sink, this.serviceId = 'mani-flutter'})
  ...
  static String nuevoTraceId() =>
      List.generate(16, (_) => _rnd.nextInt(256).toRadixString(16).padLeft(2, '0')).join();

  void info(String message, {required String traceId, String? tenantId, Map<String, Object?> extra = const {}}) =>
      _emitir('INFO', message, traceId, tenantId, extra);

  void error(String message, {required String traceId, String? tenantId, Map<String, Object?> extra = const {}}) =>
      _emitir('ERROR', message, traceId, tenantId, extra);

  void _emitir(String level, String message, String traceId, String? tenantId, Map<String, Object?> extra) {
    _sink(jsonEncode({
