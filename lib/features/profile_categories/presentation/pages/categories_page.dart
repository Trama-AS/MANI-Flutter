              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Text('Mis categorías',
                          style: TextStyle(fontSize: 19, fontWeight: FontWeight.w600, color: Color(0xFF1A1A1A))),
                    ],
                  ),
                ),
                const Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: isSelected ? const Icon(Icons.check, size: 14, color: Color(0xFF1A1A1A)) : null,
                                ),
                              ],
                            ),
                          ),
                ...
                if (state.showError)
                  Container(
                    ...
                    child: const Row(children: [
                      ...
                      SizedBox(width: 8),
                      Expanded(
                        child: Text('Selecciona al menos una categoría para continuar.',
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('${state.selectedIds.length} categoría(s) seleccionada(s)',
